...
impl InteractiveSession {
    ...
    pub async fn run(&mut self) -> Result<()> {
        println!("{}", style("Welcome to ChainGuard Interactive Mode!").bold().cyan());
        if self.ai_enabled {
    ...
    async fn analyze_interactive(&self) -> Result<()> {
        let path: String = Input::with_theme(&ColorfulTheme::default())
            ...
            .default(self.working_directory.as_ref()
    ...
    fn show_help(&self) {
        println!("{}", style("ChainGuard Interactive Mode Help").bold().cyan());
        println!("{}", style("================================").dim());
        println!();
        println!("• {} - Perform comprehensive security analysis", style("Analyze").bold());
        println!("• {} - Quick vulnerability scan", style("Scan").bold());
        println!("• {} - Validate AI-generated code", style("Validate").bold());
        println!("• {} - Run performance benchmarks", style("Benchmark").bold());
        println!("• {} - Change the working directory", style("Change directory").bold());
        println!("• {} - Enable/disable AI assistance", style("Toggle AI").bold());
        println!();
